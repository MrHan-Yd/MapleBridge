...
/* 新增，清空表单内容 */
function clearTypesAnnouncementForm() {
  form.typeId = '';
  form.typeName = '';
  form.description = '';
...
#announcement_type >>> #top {
  padding-left: 10px;
  padding-right: 10px;
  //margin: 10px ;
}

#announcement_type >>> #bottom {
  padding-left: 10px;
  padding-right: 10px;
  padding-bottom: 10px;
}

#announcement_type >>> #buttons {

}

#announcement_type >>> #tables {
  margin-top: 20px;
}
...
#announcement_type >>> .form-top {
  margin-top: 25px;
}

#announcement_type >>> .pagination {
  margin-top: 12px;
  display: flex;
