...
import {getUserId, post, get, put} from "@/net/http";
...
#permission_status >>> #top {
  padding-left: 10px;
  padding-right: 10px;
  //margin: 10px ;
}

#permission_status >>> #bottom {
  padding-left: 10px;
  padding-right: 10px;
  padding-bottom: 10px;
}

#permission_status >>> #buttons {

}

#permission_status >>> #tables {
  margin-top: 20px;
}

#permission_status >>> .title {
  display: block;
  padding-top: 10px;
  font-size: 18px;
}

#permission_status >>> .form-top {
  margin-top: 25px;
}

#permission_status >>> .pagination {
  margin-top: 12px;
  display: flex;
